...
Sistema completo de gestión de libros implementado con Spring Boot, MySQL y Docker. Esta aplicación proporciona un servicio REST completo para operaciones CRUD sobre la entidad Libro.
